...
The primary source is the local *MPC603e & EC603e RISC Microprocessors User's Manual*, `1997_MPC603EUM_MPC603e_EC603e_Users_Manual.pdf` (MPC603EUM/AD, 11/97). Physical PDF pages are used below. Chapter 7 is PDF 277–308 / printed 7-1–7-32; Chapter 8 is PDF 309–354 / printed 8-1–8-46. [`docs/references/SOURCES.md`](SOURCES.md) records source precedence and PID7v qualifications.
...
- `sim/spec/bus_encodings.json`: all Table 7-1/7-2 TT values, PID7v Table 7-3 HID0[ABE] overlays, and all nine Table 7-5 `TBST`/`TSIZ` combinations. See [`docs/references/BUS_ENCODINGS.md`](BUS_ENCODINGS.md).
