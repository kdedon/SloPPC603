...
module tb_divw_decode;
  ...
  task automatic check_form(
    ...
    insn = (32'd31 << 26) | (32'(rd) << 21) | (32'(ra) << 16) |
           (32'(rb) << 11) | (32'(oe) << 10) | (32'd491 << 1) | 32'(rc);
    #1;
    require(!uop.illegal && uop.gpr_write && uop.op == ALU_DIVW,
            "DIVW did not decode to the signed divide operation");
  ...
  initial begin
    require(IQ_DEPTH == 6, "DIVW decode fixture resource assumption");
    ...
    $display("PASS DIVW decode: all registers/OE/Rc, 64-bit DIVD excluded (%0d checks)", checks);
    $finish;
  end
endmodule
