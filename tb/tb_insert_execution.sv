// Rotate insert: captured count/SO, pending data or count, held packets.
/* verilator lint_off BLKSEQ */
module tb_insert_execution;
  import ppc_pkg::*;
  ...
  initial begin
    ...
    run_case(ALU_RLWIMI, 1'b0, 5'd0, 32'h12345678, 32'haaaa5555, 32'h00ff0000,
             1'b1, 1'b0, 1'b0, 1'b0, 1'b1,
             32'haa345555, 1'b0, 1'b0, 1'b0, 4'h8);
    run_case(ALU_RLWIMI, 1'b1, 5'd0, 32'h12345678, 32'haabbccdd, 32'hff0000ff,
             1'b1, 1'b1, 1'b0, 1'b0, 1'b1,
             32'h12bbcc78, 1'b0, 1'b0, 1'b0, 4'h5);
    run_case(ALU_RLWIMI, 1'b0, 5'd1, 32'h80000001, 32'hffffffff, 32'hffffffff,
             1'b1, 1'b0, 1'b0, 1'b0, 1'b1,
             32'h00000003, 1'b0, 1'b0, 1'b0, 4'h4);
    run_case(ALU_RLWIMI, 1'b1, 5'd31, 32'h80000001, 32'h00000000, 32'hffffffff,
             1'b1, 1'b1, 1'b0, 1'b0, 1'b1,
             32'hc0000000, 1'b0, 1'b0, 1'b0, 4'h9);
    run_case(ALU_RLWIMI, 1'b0, 5'd0, 32'h00000000, 32'hffffffff, 32'h00000001,
             1'b1, 1'b0, 1'b0, 1'b0, 1'b1,
             32'hfffffffe, 1'b0, 1'b0, 1'b0, 4'h8);
    run_case(ALU_RLWIMI, 1'b1, 5'd0, 32'hffffffff, 32'h00000000, 32'h00000001,
             1'b1, 1'b1, 1'b0, 1'b0, 1'b1,
             32'h00000001, 1'b0, 1'b0, 1'b0, 4'h5);
    run_case(ALU_RLWIMI, 1'b0, 5'd0, 32'h00000000, 32'h80000000, 32'h00000001,
             1'b1, 1'b0, 1'b0, 1'b0, 1'b1,
             32'h80000000, 1'b0, 1'b0, 1'b0, 4'h8);
    run_case(ALU_RLWIMI, 1'b1, 5'd0, 32'h00000001, 32'h00000000, 32'hfffffffe,
             1'b1, 1'b1, 1'b0, 1'b0, 1'b1,
             32'h00000000, 1'b0, 1'b0, 1'b0, 4'h3);
    $display("PASS insert execution: captured SH/mask/SO and pending source/old destination, packet stall (%0d checks)", checks);
    $finish;
  end
