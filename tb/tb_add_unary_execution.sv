// Direct ADDME/ADDZE carry-input and injected-operand checks with delayed operand wake and IU stalls.
/* verilator lint_off BLKSEQ */
module tb_add_unary_execution;
  import ppc_pkg::*;
  ...
  initial begin
    ...
    run_case(ALU_ADDME, 32'h0000_0000, 32'hffff_ffff,
             1'b0, 1'b0, 1'b1, 1'b1, 1'b1,
             32'hffff_ffff, 1'b0, 1'b0, 1'b0, 4'h8);
    run_case(ALU_ADDME, 32'h8000_0000, 32'hffff_ffff,
             1'b0, 1'b0, 1'b1, 1'b1, 1'b1,
             32'h7fff_ffff, 1'b1, 1'b1, 1'b1, 4'h5);
    // ADDME with CA=1 preserves its source but always produces carry=1.
    run_case(ALU_ADDME, 32'h0000_0000, 32'hffff_ffff,
             1'b1, 1'b1, 1'b1, 1'b1, 1'b1,
             32'h0000_0000, 1'b1, 1'b0, 1'b1, 4'h3);
    run_case(ALU_ADDME, 32'h8000_0000, 32'hffff_ffff,
             1'b1, 1'b0, 1'b1, 1'b1, 1'b1,
             32'h8000_0000, 1'b1, 1'b0, 1'b0, 4'h8);
    run_case(ALU_ADDZE, 32'h7fff_ffff, 32'h0000_0000,
             1'b1, 1'b0, 1'b1, 1'b1, 1'b1,
             32'h8000_0000, 1'b0, 1'b1, 1'b1, 4'h9);
    run_case(ALU_ADDZE, 32'hffff_ffff, 32'h0000_0000,
             1'b1, 1'b1, 1'b1, 1'b1, 1'b1,
             32'h0000_0000, 1'b1, 1'b0, 1'b1, 4'h3);
    run_case(ALU_ADDZE, 32'h8000_0000, 32'h0000_0000,
             1'b0, 1'b1, 1'b1, 1'b1, 1'b1,
             32'h8000_0000, 1'b0, 1'b0, 1'b1, 4'h9);

    $display("PASS unary ADD execution: held CA/SO, signed decrement/increment and CR0, packet stall (%0d checks)", checks);
    $finish;
  end
