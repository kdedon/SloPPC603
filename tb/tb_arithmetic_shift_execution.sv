// Arithmetic shifts: captured count/SO, pending data or count, held packets.
/* verilator lint_off BLKSEQ */
module tb_arithmetic_shift_execution;
  import ppc_pkg::*;
  ...
  initial begin
    ...
    run_case(ALU_SRAW, 1'b0, 32'h80000001, 32'h00000000, 32'hffffffff,
             1'b1, 1'b0, 1'b1, 1'b0, 1'b1,
             32'h80000001, 1'b0, 1'b0, 1'b0, 4'h8);
    run_case(ALU_SRAW, 1'b1, 32'hfffffff8, 32'h00000001, 32'hffffffff,
             1'b1, 1'b1, 1'b1, 1'b0, 1'b1,
             32'hfffffffc, 1'b0, 1'b0, 1'b0, 4'h9);
    run_case(ALU_SRAW, 1'b0, 32'hfffffff9, 32'h00000001, 32'hffffffff,
             1'b0, 1'b0, 1'b1, 1'b0, 1'b1,
             32'hfffffffc, 1'b1, 1'b0, 1'b0, 4'h8);
    run_case(ALU_SRAW, 1'b1, 32'h00000001, 32'h00000001, 32'hffffffff,
             1'b1, 1'b1, 1'b1, 1'b0, 1'b1,
             32'h00000000, 1'b0, 1'b0, 1'b0, 4'h3);
    run_case(ALU_SRAW, 1'b0, 32'h80000000, 32'h0000001f, 32'hffffffff,
             1'b1, 1'b0, 1'b1, 1'b0, 1'b1,
             32'hffffffff, 1'b0, 1'b0, 1'b0, 4'h8);
    run_case(ALU_SRAW, 1'b1, 32'h80000000, 32'h00000020, 32'hffffffff,
             1'b0, 1'b1, 1'b1, 1'b0, 1'b1,
             32'hffffffff, 1'b1, 1'b0, 1'b0, 4'h9);
    run_case(ALU_SRAW, 1'b0, 32'hffffffff, 32'h0000003f, 32'hffffffff,
             1'b0, 1'b0, 1'b1, 1'b0, 1'b1,
             32'hffffffff, 1'b1, 1'b0, 1'b0, 4'h8);
    run_case(ALU_SRAW, 1'b1, 32'h7fffffff, 32'h0000003f, 32'hffffffff,
             1'b1, 1'b1, 1'b1, 1'b0, 1'b1,
             32'h00000000, 1'b0, 1'b0, 1'b0, 4'h3);
    run_case(ALU_SRAW, 1'b0, 32'hffffffff, 32'h00000040, 32'hffffffff,
             1'b1, 1'b0, 1'b1, 1'b0, 1'b1,
             32'hffffffff, 1'b0, 1'b0, 1'b0, 4'h8);
    run_case(ALU_SRAW, 1'b1, 32'h80000001, 32'h80000001, 32'hffffffff,
             1'b0, 1'b1, 1'b1, 1'b0, 1'b1,
             32'hc0000000, 1'b1, 1'b0, 1'b0, 4'h9);
    $display("PASS arithmetic shift execution: captured six-bit count/SO and pending data/count, packet stall (%0d checks)", checks);
    $finish;
  end
