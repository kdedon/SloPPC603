// Logical shifts: captured count/SO, pending data or count, held packets.
/* verilator lint_off BLKSEQ */
module tb_shift_execution;
  import ppc_pkg::*;
  ...
  initial begin
    ...
    // Literal six-bit-count answers, both pending operand positions.
    run_case(ALU_SLW, 1'b0, 32'h80000001, 32'h00000000, 32'hffff_ffff,
             1'b1, 1'b0, 1'b0, 1'b0, 1'b1,
             32'h80000001, 1'b0, 1'b0, 1'b0, 4'h8);
    run_case(ALU_SRW, 1'b1, 32'h80000000, 32'h00000001, 32'hffff_ffff,
             1'b1, 1'b0, 1'b0, 1'b0, 1'b1,
             32'h40000000, 1'b0, 1'b0, 1'b0, 4'h4);
    run_case(ALU_SLW, 1'b1, 32'h00000001, 32'h0000001f, 32'hffff_ffff,
             1'b1, 1'b1, 1'b0, 1'b0, 1'b1,
             32'h80000000, 1'b0, 1'b0, 1'b0, 4'h9);
    run_case(ALU_SRW, 1'b0, 32'hffffffff, 32'h0000001f, 32'hffff_ffff,
             1'b1, 1'b1, 1'b0, 1'b0, 1'b1,
             32'h00000001, 1'b0, 1'b0, 1'b0, 4'h5);
    run_case(ALU_SLW, 1'b1, 32'hffffffff, 32'h00000020, 32'hffff_ffff,
             1'b1, 1'b1, 1'b0, 1'b0, 1'b1,
             32'h00000000, 1'b0, 1'b0, 1'b0, 4'h3);
    run_case(ALU_SRW, 1'b1, 32'hffffffff, 32'h0000003f, 32'hffff_ffff,
             1'b1, 1'b0, 1'b0, 1'b0, 1'b1,
             32'h00000000, 1'b0, 1'b0, 1'b0, 4'h2);
    run_case(ALU_SLW, 1'b0, 32'h80000001, 32'h00000040, 32'hffff_ffff,
             1'b1, 1'b1, 1'b0, 1'b0, 1'b0,
             32'h80000001, 1'b0, 1'b0, 1'b0, 4'h0);
    run_case(ALU_SRW, 1'b1, 32'h80000000, 32'h00000041, 32'hffff_ffff,
             1'b1, 1'b1, 1'b0, 1'b0, 1'b1,
             32'h40000000, 1'b0, 1'b0, 1'b0, 4'h5);
    run_case(ALU_SLW, 1'b1, 32'h00000001, 32'h80000001, 32'hffff_ffff,
             1'b1, 1'b0, 1'b0, 1'b0, 1'b1,
             32'h00000002, 1'b0, 1'b0, 1'b0, 4'h4);
    run_case(ALU_SRW, 1'b1, 32'hffffffff, 32'hffffffff, 32'hffff_ffff,
             1'b1, 1'b1, 1'b0, 1'b0, 1'b1,
             32'h00000000, 1'b0, 1'b0, 1'b0, 4'h3);

    $display("PASS logical shift execution: captured six-bit count/SO and pending data/count, packet stall (%0d checks)", checks);
    $finish;
  end
