...
module tb_subextend_execution;
  ...
  task automatic run_case(
    ...
    if (!(result_valid && result == expected_packet))
      $display("SUBFE mismatch A=%h B=%h CAin=%b got=%h expected=%h", source_a, source_b, ca_in, result, expected_packet);
  ...
  initial begin
    ...
    run_case(ALU_SUBFE, 1'b1, 32'h00000000, 32'h00000000, 32'hffffffff,
             1'b1, 1'b1, 1'b1, 1'b1, 1'b1,
             32'h00000000, 1'b1, 1'b0, 1'b1, 4'h3);
    run_case(ALU_SUBFE, 1'b0, 32'h00000000, 32'h80000000, 32'hffffffff,
             1'b0, 1'b0, 1'b1, 1'b1, 1'b1,
             32'h7fffffff, 1'b1, 1'b1, 1'b1, 4'h5);
    run_case(ALU_SUBFE, 1'b1, 32'h00000000, 32'h80000000, 32'hffffffff,
             1'b1, 1'b1, 1'b1, 1'b1, 1'b1,
    ...
    run_case(ALU_SUBFE, 1'b1, 32'h80000000, 32'hffffffff, 32'hffffffff,
             1'b1, 1'b1, 1'b1, 1'b1, 1'b1,
             32'h7fffffff, 1'b1, 1'b0, 1'b1, 4'h5);
    run_case(ALU_SUBFE, 1'b0, 32'h7fffffff, 32'h80000000, 32'hffffffff,
             1'b0, 1'b0, 1'b1, 1'b1, 1'b1,
             32'h00000000, 1'b1, 1'b1, 1'b1, 4'h3);
    run_case(ALU_SUBFE, 1'b1, 32'h80000000, 32'h7fffffff, 32'hffffffff,
             1'b1, 1'b1, 1'b1, 1'b1, 1'b1,
             32'hffffffff, 1'b0, 1'b1, 1'b1, 4'h9);
    run_case(ALU_SUBFE, 1'b0, 32'hffffffff, 32'hffffffff, 32'hffffffff,
             1'b0, 1'b0, 1'b1, 1'b1, 1'b1,
             32'hffffffff, 1'b0, 1'b0, 1'b0, 4'h8);
    run_case(ALU_SUBFE, 1'b1, 32'hffffffff, 32'hffffffff, 32'hffffffff,
             1'b1, 1'b1, 1'b1, 1'b1, 1'b1,
             32'h00000000, 1'b1, 1'b0, 1'b1, 4'h3);
    run_case(ALU_SUBFE, 1'b0, 32'h00000001, 32'h00000000, 32'hffffffff,
             1'b0, 1'b0, 1'b1, 1'b1, 1'b1,
             32'hfffffffe, 1'b0, 1'b0, 1'b0, 4'h8);
    run_case(ALU_SUBFE, 1'b1, 32'h00000001, 32'h00000000, 32'hffffffff,
             1'b1, 1'b1, 1'b1, 1'b1, 1'b1,
             32'hffffffff, 1'b0, 1'b0, 1'b1, 4'h9);
    run_case(ALU_SUBFE, 1'b0, 32'h80000000, 32'h00000000, 32'hffffffff,
             1'b0, 1'b0, 1'b1, 1'b1, 1'b1,
             32'h7fffffff, 1'b0, 1'b0, 1'b0, 4'h4);
    run_case(ALU_SUBFE, 1'b1, 32'h80000000, 32'h00000000, 32'hffffffff,
             1'b1, 1'b1, 1'b1, 1'b1, 1'b1,
             32'h80000000, 1'b0, 1'b1, 1'b1, 4'h9);
    $display("PASS SUBFE execution: captured operands/SO and overflow, packet stall (%0d checks)", checks);
    $finish;
  end
