...
module tb_core_crstate_edges;
  ...
  function automatic logic [31:0] instruction(input logic [31:0] pc);
    case(pc)
      ...
      28:return kind==0 ? 32'h4e880000 : 32'h7e800400;
        ...
        case(expected_pc)
          ...
          28:begin
            ...
            require(!retired.gpr_write && retired.write_cr0 && retired.cr_field==5 &&
                    ...
                    "CR state retirement permissions/data");
          end
          32,32'h100:begin
  ...
  initial begin
    ...
    $display("PASS CR state edges: before-finish kill, held head, kept finish/commit, CR/XER/GPR preservation (%0d checks)",checks);
    $finish;
  end
