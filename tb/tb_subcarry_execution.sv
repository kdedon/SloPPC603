...
module tb_subcarry_execution;
  ...
  initial begin
    ...
    run_case(ALU_SUBFC, 1'b0, 32'h00000000, 32'h00000000, 32'hffffffff,
             1'b0, 1'b0, 1'b1, 1'b1, 1'b1,
             32'h00000000, 1'b1, 1'b0, 1'b0, 4'h2);
    run_case(ALU_SUBFC, 1'b1, 32'h00000001, 32'h00000000, 32'hffffffff,
             1'b1, 1'b1, 1'b1, 1'b1, 1'b1,
             32'hffffffff, 1'b0, 1'b0, 1'b1, 4'h9);
    run_case(ALU_SUBFC, 1'b0, 32'h00000000, 32'h00000001, 32'hffffffff,
             1'b0, 1'b0, 1'b1, 1'b1, 1'b1,
             32'h00000001, 1'b1, 1'b0, 1'b0, 4'h4);
    run_case(ALU_SUBFC, 1'b1, 32'h80000000, 32'h00000000, 32'hffffffff,
             1'b1, 1'b1, 1'b1, 1'b1, 1'b1,
             32'h80000000, 1'b0, 1'b1, 1'b1, 4'h9);
    run_case(ALU_SUBFC, 1'b0, 32'h7fffffff, 32'h80000000, 32'hffffffff,
             1'b0, 1'b0, 1'b1, 1'b1, 1'b1,
             32'h00000001, 1'b1, 1'b1, 1'b1, 4'h5);
    run_case(ALU_SUBFC, 1'b1, 32'hffffffff, 32'h7fffffff, 32'hffffffff,
             1'b1, 1'b1, 1'b1, 1'b1, 1'b1,
             32'h80000000, 1'b0, 1'b1, 1'b1, 4'h9);
    run_case(ALU_SUBFC, 1'b0, 32'h80000000, 32'hffffffff, 32'hffffffff,
             1'b0, 1'b0, 1'b1, 1'b1, 1'b1,
             32'h7fffffff, 1'b1, 1'b0, 1'b0, 4'h4);
    run_case(ALU_SUBFC, 1'b1, 32'hffffffff, 32'hffffffff, 32'hffffffff,
             1'b0, 1'b1, 1'b1, 1'b1, 1'b1,
             32'h00000000, 1'b1, 1'b0, 1'b1, 4'h3);
    $display("PASS SUBFC execution: captured operands/SO and overflow, packet stall (%0d checks)", checks);
    $finish;
  end
