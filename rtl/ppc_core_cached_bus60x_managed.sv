...
module ppc_core_cached_bus60x_managed #(
  ...
  assign imem_req_ready = managed_fetch_ready && !transport_ifetch_error;
  assign imem_rsp_valid = cache_fetch_rsp_valid &&
                          !cache_fetch_rsp_error && !transport_ifetch_error;
  ...
  ppc_bus60x_arbiter scalar_router (
    ...
    .imem_req_ready_o(bypass_req_ready),
    .imem_req_addr_i(bypass_req_addr),
  ...
  assign transport_ifetch_error = ifetch_error_q ||
                                    scalar_router_ifetch_error;
